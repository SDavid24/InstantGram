...
//It takes in an instance of  thumbnail request and returns a future of image with aspect ratio
final thumbnailProvider = FutureProvider.family.autoDispose<ImageWithAspectRatio,
    ThumbnailRequest>(
        (ref, ThumbnailRequest request,) async {
          final Image image;

          switch(request.fileType){
            case FileType.image: //If it is a image
              image = Image.file(
                request.file,
                fit: BoxFit.fitHeight,
              );
            break;
            case FileType.video: //If it is a video
